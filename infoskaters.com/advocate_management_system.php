<?php
$title="Advocate Management System |Advocate Management System Development Company in India";
$keywords="advocate management system development company, advocate management system websites software development, best advocate management system websites, advocate management system, reword website script";
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Products</li>
                        <li class="active">Advocate Management System </li>
                    </ol><!-- /End breadcrumb -->
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/Advocate_Management_System.png" alt="Advocate Management System" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 title-block">
                                        ...
                                        <div class="title-block-container">
                                            ...
                                            <!-- Title -->
                                            <h1>Advocate Management System</h1>
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>Advocate Management System Is A Web Based Application For Advocates And Law Firm To Maintain Their Office. This Software Is Very Easy To Operate And Light On System Tool To Maintain Information About Clients, Cases, Hearings Etc</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Contact</a></h4>

                                                <!-- Description -->
                                                <p>You could add with categories contact for your clients.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Appointment
</a></h4>

                                                <!-- Description -->
                                                <p>Appointment setup with date and time, dont missed schedule.
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <a href="https://demo.infoskaters.com/advocate_system/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: Infoskaters.com@gmail.com</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://www.infoskaters.com/demo/InfoskatersAdvocate/login
">View Demo</a>
    </div>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;">
        ...
        <a href="https://www.infoskaters.com/demo/InfoskatersAdvocate/login">View Demo</a>
    </div>
