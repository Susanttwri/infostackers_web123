<?php
$title="Advance Support Ticket System |Advance Support Ticket System Development Company in India";
$keywords="advance support ticket system development company, advance support ticket system websites software development, best advance support ticket system websites, advance support ticket system, reword website script";
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Products</li>
                        <li class="active">Advance Support Ticket System </li>
                    </ol><!-- /End breadcrumb -->
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/support.png" alt="Advance Support Ticket System" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 title-block">
                                        ...
                                        <div class="title-block-container">
                                            ...
                                            <!-- Title -->
                                            <h1>Advance Support Ticket System</h1>
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>Best Support System, Best by name, Best by nature, Best by feature, it is a self-hosted customer support desk software. It handles support tickets, manages email tickets, collects any payment by PayPal.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Email Piping</a></h4>

                                                <!-- Description -->
                                                <p>Best Support System provide you the email to ticket functionality. Tickets can be created by simply sending an email. Ticket responses can also be created by replying to the same email.
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Simple And Intuitive UI
</a></h4>

                                                <!-- Description -->
                                                <p>With an intuitive UI that has been designed to boost agent productivity, Best Support System makes it easy for your team to provide support with no distractions.
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        <p style="font-size: 16px;">Username: admin</p>
        <p style="font-size: 16px;">Password: admin@123</p>
      
        <a href="https://www.infoskaters.com/demo/best-support-system/support-system/admin"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      ...
      <a href="https://www.infoskaters.com/demo/best-support-system/support-system/"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: admin</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://www.infoskaters.com/demo/best-support-system/support-system/admin
">View Demo</a>
    </div>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;">
        ...
        <a href="https://www.infoskaters.com/demo/best-support-system/support-system/
">View Demo</a>
    </div>
