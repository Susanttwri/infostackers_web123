<?php
$title="Gym Management System|Gym Management System Company in India";
$keywords="online exam portal company, online exam portal development, best online exam portal software  websites, online exam portal software system, reword website script";
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Products</li>
                        <li class="active">Gym Management System</li>
                    </ol><!-- /End breadcrumb -->
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/gym_mng.png" alt="News Portal" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>InfoskatersGym is a gym management application which helps gym owners to manage their gym clients, payments, memberships and much more.
 </p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Admin Module</a></h4>

                                                <!-- Description -->
                                                <p>Managing other accounts, Manage Members, Inventry, Business Information etc
...
.
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">System Settings

</a></h4>

                                                <!-- Description -->
                                                <p>General Settings, Email, Permission Setup Backup Restore, System Update and more.
                                          ...
                                          <p style="margin-top:20px;margin-left:20px;font-size:18px;font-weight:bold">Login details are provided below to try the demo. Click Here to view login details:-</p>
	...
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <p style="font-size: 16px;">Password: admin@123</p>
           <a href="https://demo.infoskaters.com/gym_management/public/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
         <p style="font-size: 16px;">Username: xyz@gmail.com</p>
        <p style="font-size: 16px;">Password: 123</p>

          <a href="https://demo.infoskaters.com/gym_management/public/customer"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
    </div>
...
<div class="login-details-content" style="margin-top: 10px; display: flex;">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: admin</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://www.infoskaters.com/demo/InfoskatersGym/public/"target="_blank">View Demo</a>
    </div>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display:none;">
        ...
        <p style="font-size: 16px;">Username: gsdeveloper1212@gmail.com</p>
        <p style="font-size: 16px;">Password: 123</p>
        <a href="https://www.infoskaters.com/demo/InfoskatersGym/public/customer
