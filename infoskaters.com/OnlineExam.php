<?php
$title="Online Exam|Online Exam Company in India";
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/online-exam.png" alt="News Portal" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>Online Exam portal is full featured online test and quiz platform built on codeigniter 3, Online Exam portal is a highly scalable and powerful Online Exam System to manage categories, quizes and multiple choice questions. Prepare candidates to perform extraordinarily with an easy to use highly interactive platform and simplify the assessment cycle. </p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Description -->
                                                <p>Managing other accounts, Manage quizes, Student, assessment etc
	...
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
       <p style="font-size: 16px;">Username: admin</p>
        ...
        <a href="https://demo.infoskaters.com/online_exam/admin/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      ...
      <a href="https://demo.infoskaters.com/online_exam"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: admin</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://infoskaters.com/demo/OnlineExam/admin/login
">View Demo</a>
    </div>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;">
        ...
        <a href="https://infoskaters.com/demo/OnlineExam/
">View Demo</a>
    </div>
