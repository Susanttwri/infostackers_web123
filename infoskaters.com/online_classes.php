<?php
$title="Online Classes|Online Classes Company in India";
$keywords="online classes portal company, online classes portal development, best online classes portal software  websites, online classes portal software system, reword website script";
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/online_class.png" alt="News Portal" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>Managing various administrative tasks in one place is now quite easy and time savior with this Online Classes portal and Give your valued time to your institute that will increase next generation productivity for our society.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Description -->
                                                <p>Managing other accounts, Manage Teacher, Student, Guardian etc
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <a href="https://demo.infoskaters.com/online-classes/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      ...
      <a href="https://demo.infoskaters.com/online-classes"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: Infoskaters.com@gmail.com</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://infoskaters.com/demo/OnlineClasses/login">View Demo</a>
    </div>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;">
        ...
        <a href="https://infoskaters.com/demo/OnlineClasses/">View Demo</a>
    </div>
