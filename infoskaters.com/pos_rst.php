<?php
$title="POS system for restaurants|POS system for restaurants Company in India";
$keywords="pos system for restaurants  portal company, pos system for restaurants portal development, best pos system for restaurants portal software  websites, pos system for restaurants software system, reword website script";
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Products</li>
                        <li class="active">POS system for restaurants</li>
                    </ol><!-- /End breadcrumb -->
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/pos_rst.png" alt="News Portal" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 title-block">
                                        ...
                                        <div class="title-block-container">
                                            ...
                                            <!-- Title -->
                                            <h1>POS system for restaurants</h1>
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>POS comes with lots of features out-of-box. You get most of the feature needed by small & Medium sized businesses to simplify the time-consuming task of accounting & inventory management and instead focus on what really matters – Your Business.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Multiple Business/Shops</a></h4>

                                                <!-- Description -->
                                                <p>Set up multiple businesses in the application.
</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Sell


</a></h4>

                                                <!-- Description -->
                                                <p>Simplified interface for selling products.</p>
	...
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      <p style="font-size: 16px;">Username: admin</p>
        ...
        <a href="https://demo.infoskaters.com/restaurants_pos/public/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: admin</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://www.infoskaters.com/demo/RestaurantsPos/public/login"target="_blank">View Demo</a>
    </div>
