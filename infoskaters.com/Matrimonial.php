<?php
$title="Matrimonial|Matrimonial Company in India";
$keywords="matrimonial company, matrimonial development, best matrimonial software  websites, matrimonial software system, reword website script";
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/matromaonial.png" alt="Advance Support Ticket System" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>Matrimonial CMS admin panel has all functions to manage a matchmaking platform. You can manage all your members, membership package, frontend website, earnings and many more.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Admin Panel</a></h4>

                                                <!-- Description -->
                                                <p>Matrimonial CMS admin panel has all functions to manage a matchmaking platform. You can manage all your members, membership package, frontend website, earnings and many more.
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Fully Manageable Frontend Website
</a></h4>

                                                <!-- Description -->
                                                <p>Front-end of  Matrimonial CMS is fully manageable. You can easily manage website header, footer, color themes, home page, policy pages, appearance from your admin dashboard.
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <a href="https://demo.infoskaters.com/Matrimonial/install/admin"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      ...
      <a href="https://demo.infoskaters.com/Matrimonial/install/"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: Infoskaters.com@gmail.com</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://www.infoskaters.com/demo/Matrimonial/install/admin
...
">View Demo</a>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;">
        ...
        <a href="https://www.infoskaters.com/demo/Matrimonial/install/">View Demo</a>
    </div>
