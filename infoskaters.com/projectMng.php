<?php
$title="Project Management software|Project Management software Company in India";
$keywords="Project Management software  portal company, Project Management software portal development, best Project Management software websites, Project Management software system, reword website script";
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Products</li>
                        <li class="active">Project Management software</li>
                    </ol><!-- /End breadcrumb -->
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/project_mng.png" alt="News Portal" / style="" class="cashback_image">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Super Admin Dashboard</a></h4>

                                                <!-- Description -->
                                                <p>Manages Overall fuctioning of the organization.
</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Manage Front Site


</a></h4>

                                                <!-- Description -->
                                                <p>Choose a theme according to your preference.</p>
...
<div class="login-details-container" style="margin-top: 5px; display: flex; justify-content: left; align-items: center;">
    ...
    <button onclick="window.dialog2.showModal();" class="btn  wave-effect">Frontend Login</button>
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <p style="font-size: 16px;">Password: 123456</p><br>
        <p style="font-size: 17px; font-weight: bold;"> Admin Login Details:</p>
        <p style="font-size: 16px;">Username: admin@example.com</p>
        <p style="font-size: 16px;">Password: 123456</p>
      
        <a href="https://demo.infoskaters.com/project_mng_software/public/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      ...
      <p style="font-size: 17px; font-weight: bold;">Employee Login Details:</p>
        <p style="font-size: 16px;">Username: employee@example.com</p>
        <p style="font-size: 16px;">Password: 123456</p><br>
        <p style="font-size: 17px; font-weight: bold;"> Client Login Details:</p>
        <p style="font-size: 16px;">Username: client@example.com</p>
        <p style="font-size: 16px;">Password: 123456</p>
      <a href="https://demo.infoskaters.com/project_mng_software/public/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: admin@example.com</p>
        <p style="font-size: 16px;">Password: 123456</p>
        <a href="https://www.infoskaters.com/demo/ProjectMngSoftware/public/login"target="_blank">View Demo</a>
    </div>
