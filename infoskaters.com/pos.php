<?php
$title="Point Of Sales|Point Of Sales Development Company in India";
$keywords="point of sales company, point of sales software development, best point of sales software pro websites, point of sales software pro system, reword website script";
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/pos.png" alt="Point Of Sales" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>POS is a software that will help you to manage your inventory, accounting and hrm. We believe that this software is suitable for both wholesale and retail buisness model and an ideal product for any Super Shop. This user friendly software is fully responsive and has many features. Hope that this software will be helpful to manage your buisness inventory.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">POS</a></h4>

                                                <!-- Description -->
                                                <p>You can create sale from POS. Customer, Warehouse and Biller (representative of your company) will be automatically selected according to POS Settings under Settings module. Touch screen keybord is activated in POS module. You can add product to order table by typing or scanning barcode of product. Featured Product will be displayed in the right side. You can also add product by clicking product image. You can edit product info from order table.
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Payments
</a></h4>

                                                <!-- Description -->
                                                <p>You can make payment from Purchase table. You can make payment with Cash, Gift Card, Cheque, Credit card and Deposit
...
<div class="login-details-container" style="margin-top: 5px; display: flex; justify-content: left; align-items: center;">
    ...
    <!--<button onclick="showFrontendLoginDetails()" class="btn wave-effect" style="margin-left: 20px;">Frontend Login</button> -->
</div>
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <a href="https://demo.infoskaters.com/POS/login"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: admin</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://www.infoskaters.com/demo/PointOfSales/login
...
">View Demo</a>
    ...
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:260px">
