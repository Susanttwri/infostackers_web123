<?php
$title="CRM Software Pro CRM Software Pro Development Company in India";
$keywords="crm software pro company, crm software pro software development, best crm software pro websites, crm software pro system, reword website script";
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Products</li>
                        <li class="active">CRM Software Pro </li>
                    </ol><!-- /End breadcrumb -->
                ...
                <div class="section-container" style="padding-top:40px;">
                    ...
                    <div class="gfort-42-column">
                        ...
                        <div class="background-image-block parallax-effect gfort-image">
                            <img src="images/crm_tool.png" alt="Advance Support Ticket System" / style="" class="cashback_image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 content-block">
                                        ...
                                        <div class="content-block-container" style=" margin-left:20px;">
                                            ...
                                            <!-- Description -->
                                            <p>CRM is self hosted Customer Relationship Management software that is a great fit for almost any company, freelancer or many other uses. With its clean and modern design,  CRM can help you look more professional to your customers and help improve business performance at the same time.</p>
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Sales Tracking">Leads</a></h4>

                                                <!-- Description -->
                                                <p>Leads or potential clients are really important part to any company. Every company trying everyday to get new leads. Very offen happend some potential client to call and ask for specific service that you company serve and then sometimes this is forgotten. With CRM you will never forget your potential clients and you will be able to manage all of them in one place. Keep track of leads in one place and easily follow their progress. Ability to auto import leads from email, add notes, create proposals. Organize your leads in stages and change stages easily with drag and drop. Ability to auto import leads from emails and web to lead forms, import leads from .CSV file included.
                                        ...
                                        <div class="col-md-12 content-block content-block-style-3">
                                            ...
                                            <div class="content-block-container">
                                                ...
                                                <!-- Title -->
                                                <h4><a href="#" title="Cashback Processing">Online Payments
</a></h4>

                                                <!-- Description -->
                                                <p>Receive payments from Paypal, Stripe, Mollie, Authorize.net, 2Checkout, PayU Money and Braintree, we have implemented payment gateways that are available in most of the countries.
...
<dialog id="dialog1">
	<h2>Admin Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
        ...
        <a href="https://demo.infoskaters.com/CRM/admin/"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<dialog id="dialog2">
	<h2>Frontend Login</h2>
	 <div id="adminLoginDetailsContainer" class="login-details-box" style="margin-left:30px">
      ...
      <a href="https://demo.infoskaters.com/CRM/clients"target="_blank" style="text-decoration: none;"><button class="primary" style="margin-top: 10px; width: 100%; height: 100%; border: none;">View Demo</button></a>
...
<div class="login-details-content" style="margin-top: 10px; display: flex; ">
    ...
    <div id="adminLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        ...
        <p style="font-size: 16px;">Username: Infoskaters.com@gmail.com</p>
        <p style="font-size: 16px;">Password: admin@123</p>
        <a href="https://demo.infoskaters.com/CRM/admin/

">View Demo</a>
    </div>

    <!-- Frontend Login Details Container -->
    <div id="frontendLoginDetailsContainer" class="login-details-box" style="display: none;margin-left:30px">
        <p style="font-size: 17px; font-weight: bold;">Frontend Login Details:</p>
       
        
        <a href="https://demo.infoskaters.com/CRM/clients">View Demo</a>
    </div>
